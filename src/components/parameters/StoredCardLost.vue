    ...
    <div class="APPX">
        <el-form :inline="true" :model="num" class="demo-form-inline">
            <el-form-item label="门店">
                <el-input type="text" v-model="num.type" class="input_box" />
            </el-form-item>
            ...
            <el-form-item>
                <el-button type="primary" @click="add">新增挂失</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table :data="table" border style="width: 100%;text-align:center">
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary">取消挂失</el-button>
                </template>
            </el-table-column>
        </el-table>
        <div class="uys">
